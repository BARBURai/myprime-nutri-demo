...
const cases = [
  ...
  },
  {
    ...
    text: '{"intro":"אני מצטערת, אני יכולה לעזור רק ברעיונות לאוכל באפליקציה הזו 🙂 רק רוצה להגיד לך, שתמיד את יכולה לשתף בקבוצת הוואטסאפ שלך, או את ענת בפרטי. אם בא לך רעיון לארוחה, כתבי לי ואשמח לעזור.","options":[],"note":""}',
    proteinFocus: true,
