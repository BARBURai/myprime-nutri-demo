...
- **Bump `VERSION` by 0.01 on every change**, and **state the new version number in the chat reply** (the owner tracks versions; it also shows in the UI). Current version: `1.55`.
...
## v1.55 - Tour polish batch + intro screen rework (owner fixes)
