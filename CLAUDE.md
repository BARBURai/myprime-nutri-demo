...
- **Bump `VERSION` by 0.01 on every change**, and **state the new version number in the chat reply** (the owner tracks versions; it also shows in the UI). Current version: `1.54`.
...
## v1.54 - Tracker: "fill vs view" label + week-2-day-3 manual-tasks coachmark
